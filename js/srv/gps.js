...
exports.savePositionInDB = function(pmsg, onDone) {
    ...
    var selAvgSpd = "(SELECT COALESCE(AVG(J.speed_in_kmh),0.0) FROM tracking.position AS J WHERE J.speed_in_kmh >= 10 AND J.person = " + pmsg.person + " AND J.t >= " + (pmsg.t - cnst.averageSpeedDurationSeconds * 1000) + " AND J.t < " + pmsg.t + ")";
